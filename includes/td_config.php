...
class td_wp_booster_config {
    ...
    static function td_global_after() {
        ...
        td_global::$js_files = array(
	        ...
	        'td_animation_scroll' =>    '/includes/js_files/td_animation_scroll.js',
	        'td_backstr' =>             '/includes/js_files/td_backstr.js',
        ...
        td_api_thumb::add('td_80x60',
            array(
                ...
                'used_on' => array(
                    'MX2', 'Block 18', 'Block 19', 'Live search'
                )
            )
        );
